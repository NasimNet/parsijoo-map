jQuery( document ).ready( function( $ ) {
    ...
    var api_map = $( '#parsijoo_api_map' ).val();

    L.tileLayer( 'https://developers.parsijoo.ir/web-service/v1/map/?type=tile&x={x}&y={y}&z={z}&apikey=' + api_map, {
        maxZoom: 19,
        minZoom: 5,
    } ).addTo( map );
    ...
    $( '#parsijoo-shortcode, .input-example' ).focus( function() {
        $( this ).select();
    } );
